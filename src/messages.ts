...
const EARLY_MORNING_MESSAGES: Message[] = [
  { title: '☀️ Good morning!', body: 'Ready to tackle your {total} tasks today?' },
  {
    ...
    body: "You've got {total} things on your list. Let's get started!",
  },
...
const MID_MORNING_MESSAGES: Message[] = [
  {
    ...
    body: 'Almost midday! How are those {total} tasks coming along?',
  },
  { title: '📈 Building momentum', body: "You've finished {done} tasks already. Keep going!" },
  {
    title: '☕ Coffee break?',
    body: 'Take a breather, then dive back into your {remaining} remaining tasks.',
  },
  {
    title: '🧘 Focus time',
    body: 'Center yourself. You have {remaining} tasks to focus on before lunch.',
  },
  {
    title: '🏃 Step by step',
    body: 'Keep the rhythm! {done}/{total} tasks are already checked off.',
  },
  {
    title: '🌟 Shine bright',
    body: 'You are doing great! {remaining} tasks to go before the lunch bell.',
  },
  {
    title: '🚂 Full steam ahead',
    body: "Mid-morning energy! Let's clear more of your {total} tasks.",
  },
  {
    title: '⚖️ Balancing act',
    body: 'Checking in on your progress: {done} done, {remaining} to go!',
  },
];
...
const EARLY_AFTERNOON_MESSAGES: Message[] = [
  ...
  {
    title: '🥤 Quick refresh?',
    body: 'Take a sip of water and tackle the next of your {remaining} tasks.',
  },
  { title: '⛰️ Halfway there!', body: 'You are moving! {done} done, {remaining} remaining.' },
  {
    title: '⚡ Power hour',
    body: "Let's use this afternoon energy to finish your {remaining} tasks.",
  },
  { title: '🧐 Review time', body: "Half the day is gone. You've cleared {done} tasks so far." },
  {
    title: '🏔️ Reaching the peak',
    body: "You've climbed through {done} tasks. Keep going for the rest!",
  },
...
const LATE_AFTERNOON_MESSAGES: Message[] = [
  {
    ...
    body: 'The day is winding down. {remaining} more tasks to cross off!',
  },
  {
    title: '⚡ Power hour',
    body: "Let's use this energy to finish your {remaining} remaining tasks.",
  },
  { title: '🏃 Sprint finish', body: 'Almost there! Can you clear these last {remaining} items?' },
  {
    title: '🌇 Sunset sprint',
    body: "Before the sun goes down, let's tackle these {remaining} tasks.",
  },
  {
    title: '📉 Tying loose ends',
    body: "Let's close out those last {remaining} items on your list.",
  },
...
const EVENING_MESSAGES: Message[] = [
  ...
  { title: '🌙 Evening review', body: 'The day is nearly over. {remaining} tasks still active.' },
  {
    ...
    body: "Don't forget your {remaining} remaining tasks before you finish!",
  },
  { title: '🌆 Sunset review', body: 'The day is winding down. {remaining} tasks still active.' },
  {
    title: '🌌 Starlit goals',
    body: 'Before you finish for the day, check your {remaining} tasks.',
  },
...
const NO_PROGRESS_MIDDAY: Message[] = [
  ...
  {
    title: '💡 Small steps',
    body: "The hardest part is starting. Let's check one of your {total} tasks off!",
  },
  { title: '🌱 Time to plant', body: 'Your {total} tasks are waiting to grow. Start one now!' },
  {
    title: '🧊 Break the ice',
    body: 'The list looks daunting? Just start with the easiest of {total}.',
  },
  ...
  {
    title: '⏱️ The clock is ticking',
    body: 'The day is moving along. Ready to start your {total} tasks?',
  },
